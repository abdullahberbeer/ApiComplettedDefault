    ...
    public class OrderController : Controller
    {
        ...
        public async Task<IActionResult> DeleteOrder([FromRoute] int orderId)
        {
            ...
            if (order)
            {
                ...
                if (updateOrder)
                {
                    return Ok("Alışveriş başarıyla silindi..");
                }
                return NotFound();
            }
            return BadRequest("Bir hata oluştu.");
        ...
        public IActionResult AddOrderItem(int UserId, int productId, int quantity)
        {
        ...
        public IActionResult DeleteFromOrder(int userId)
        {
            _orderService.DeleteFromOrder(userId);
            return Ok("Silme başarılı");
