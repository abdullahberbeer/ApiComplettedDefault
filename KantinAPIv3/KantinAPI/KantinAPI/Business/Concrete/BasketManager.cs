...
namespace KantinAPI.Business.Concrete
{
    public class BasketManager : IBasketService
    {
        ...
        public async Task<Basket> AddToCart(AddBasketItemDto entity)
        {
            ...
            if (cart != null)
            {
                ...
                if (index<0)
                {
                    ...
                    cart.BasketItems.Add(new BasketItem()
                    {
                        ...
                        Adet = entity.Quantity,
                        BasketId = cart.Id,
                        TotalPrice=(double)p.Price*entity.Quantity
                ...
                else
                {
                    ...
                    cart.BasketItems[index].Adet += entity.Quantity;
                    cart.BasketItems[index].TotalPrice +=(double)p.Price * entity.Quantity;
                    cart.TotalPaye = cart.BasketItems.Sum(x => x.TotalPrice);
                }
